...
:LinkPluginsGuide: https://access.redhat.com/documentation/en-us/red_hat_developer_hub/{product-version}/html-single/confuguring_plugins_in_red_hat_developer_hub/index
